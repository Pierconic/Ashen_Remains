...
public class CharredStrippingProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() instanceof AxeItem) {
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == AshenremainsModBlocks.CHARRED_WOOD_WOOD.get()) {
				world.setBlock(BlockPos.containing(x, y, z), AshenremainsModBlocks.CHARRED_STRIPPED_WOOD.get().defaultBlockState(), 3);
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == AshenremainsModBlocks.CHARRED_WOOD_LOG.get()) {
				world.setBlock(BlockPos.containing(x, y, z), AshenremainsModBlocks.CHARRED_STRIPPED_LOG.get().defaultBlockState(), 3);
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("item.axe.strip")), SoundSource.NEUTRAL, 1, 1);
					} else {
