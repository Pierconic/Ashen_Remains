...
public class FlamingAshDamageProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof ItemEntity) {
			if (!((entity instanceof ItemEntity _itemEnt ? _itemEnt.getItem() : ItemStack.EMPTY).is(ItemTags.create(ResourceLocation.parse("forge:fire_resist"))))) {
				entity.igniteForSeconds(15);
			}
		} else {
			if (Math.random() < 0.003 && !((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY)
				...
				if (world instanceof ServerLevel _level) {
					(entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).hurtAndBreak(3, _level, null, _stkprov -> {
					});
				}
				if (!(entity instanceof LivingEntity _livEnt39 && _livEnt39.hasEffect(MobEffects.FIRE_RESISTANCE)) && !entity.getType().is(TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.parse("forge:ash_immune")))
			...
			if (Math.random() < 0.003 && !((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.LEGS) : ItemStack.EMPTY)
					.getEnchantmentLevel(world.registryAccess().lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(Enchantments.FIRE_PROTECTION)) != 0)) {
				if (world instanceof ServerLevel _level) {
					(entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).hurtAndBreak(3, _level, null, _stkprov -> {
					});
				}
				if (!(entity instanceof LivingEntity _livEnt61 && _livEnt61.hasEffect(MobEffects.FIRE_RESISTANCE)) && !entity.getType().is(TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.parse("forge:ash_immune")))
			...
			if ((world.getBlockState(BlockPos.containing(x, y + 1, z))).is(BlockTags.create(ResourceLocation.parse("forge:ashblocks"))) || (world.getBlockState(BlockPos.containing(x, y + 1, z))).getBlock() == AshenremainsModBlocks.ASH.get()
				...
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(MobEffects.DARKNESS, 300, 1, false, false));
				if (Math.random() < 0.003 && !((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.CHEST) : ItemStack.EMPTY)
						.getEnchantmentLevel(world.registryAccess().lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(Enchantments.FIRE_PROTECTION)) != 0)) {
					if (world instanceof ServerLevel _level) {
					...
					if (!(entity instanceof LivingEntity _livEnt81 && _livEnt81.hasEffect(MobEffects.FIRE_RESISTANCE)) && !entity.getType().is(TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.parse("forge:ash_immune")))
