...
import net.mcreator.ashenremains.init.AshenremainsModBlockEntities;
...
public class AshenremainsMod {
	...
	public AshenremainsMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		AshenremainsModBlocks.REGISTRY.register(modEventBus);
		AshenremainsModBlockEntities.REGISTRY.register(modEventBus);
		AshenremainsModItems.REGISTRY.register(modEventBus);
		AshenremainsModEntities.REGISTRY.register(modEventBus);
		AshenremainsModTabs.REGISTRY.register(modEventBus);

		StructureFeature.REGISTRY.register(modEventBus);

		AshenremainsModParticleTypes.REGISTRY.register(modEventBus);
