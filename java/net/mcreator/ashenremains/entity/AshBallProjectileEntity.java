...
public class AshBallProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(AshenremainsModItems.ASH_BALL.get());
	...
	public AshBallProjectileEntity(EntityType<? extends AshBallProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
		super(type, x, y, z, world, PROJECTILE_ITEM, firedFromWeapon);
	}

	public AshBallProjectileEntity(EntityType<? extends AshBallProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	protected ItemStack getDefaultPickupItem() {
		return new ItemStack(AshenremainsModItems.ASH_BALL.get());
	}
	...
	public void playerTouch(Player entity) {
		...
		AshBallBlindnessChanceProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), entity, this.getOwner());
	}

	@Override
	public void onHitEntity(EntityHitResult entityHitResult) {
		super.onHitEntity(entityHitResult);
		AshBallBlindnessChanceProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), entityHitResult.getEntity(), this.getOwner());
	}

	@Override
	public void onHitBlock(BlockHitResult blockHitResult) {
		super.onHitBlock(blockHitResult);
		AshBallProjectileHitsBlockProcedure.execute(this.level(), blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ());
	}

	@Override
	public void tick() {
		super.tick();
		AshBallTrailProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
		if (this.inGround)
			this.discard();
	}
	...
	public static AshBallProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
	...
	public static AshBallProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		AshBallProjectileEntity entityarrow = new AshBallProjectileEntity(AshenremainsModEntities.ASH_BALL_PROJECTILE.get(), entity, world, null);
	...
	public static AshBallProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		AshBallProjectileEntity entityarrow = new AshBallProjectileEntity(AshenremainsModEntities.ASH_BALL_PROJECTILE.get(), entity, entity.level(), null);
